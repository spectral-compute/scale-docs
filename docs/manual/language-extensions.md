...
Introduced almost entirely to implement `threadIdx` and friends, this language
extension is available in all modes of the SCALE compiler.

Given:

```
[[clang::getter(someFunction)]] int example;
```
