...
This page shows how the SCALE device library corresponds to various
...
=== "12.9"
    ...
    ```
    ## [2. FP6 Intrinsics](https://docs.nvidia.com/cuda/archive/12.9.1/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__FP6.html)
    ```diff
    -6 bit floating point is not supported
    ```
    ## [3. FP8 Intrinsics](https://docs.nvidia.com/cuda/archive/12.9.1/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__FP8.html)
    ```diff
    -8 bit floating point is not supported
    ```
    ## [4. Half Precision Intrinsics](https://docs.nvidia.com/cuda/archive/12.9.1/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__HALF.html)
    ```diff
    ...
    ```
    ## [5. Bfloat16 Precision Intrinsics](https://docs.nvidia.com/cuda/archive/12.9.1/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__BFLOAT16.html)
    ```diff
    ...
    ```
    ## [6. Single Precision Mathematical Functions](https://docs.nvidia.com/cuda/archive/12.9.1/cuda-math-api/cuda_math_api/group__CUDA__MATH__SINGLE.html)
    ```diff
    ...
    ```
    ## [7. Single Precision Intrinsics](https://docs.nvidia.com/cuda/archive/12.9.1/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__SINGLE.html)
    ```diff
    ...
    ```
    ## [8. Double Precision Mathematical Functions](https://docs.nvidia.com/cuda/archive/12.9.1/cuda-math-api/cuda_math_api/group__CUDA__MATH__DOUBLE.html)
    ```diff
    ...
    ```
    ## [9. Double Precision Intrinsics](https://docs.nvidia.com/cuda/archive/12.9.1/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__DOUBLE.html)
    ```diff
    ...
    ```
    ## [10. FP128 Quad Precision Mathematical Functions](https://docs.nvidia.com/cuda/archive/12.9.1/cuda-math-api/cuda_math_api/group__CUDA__MATH__QUAD.html)
    ```diff
    -128 bit floating point is not supported
    ```
    ## [11. Type Casting Intrinsics](https://docs.nvidia.com/cuda/archive/12.9.1/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__CAST.html)
    ```diff
    ...
    ```
    ## [12. Integer Mathematical Functions](https://docs.nvidia.com/cuda/archive/12.9.1/cuda-math-api/cuda_math_api/group__CUDA__MATH__INT.html)
    ```diff
    ...
    ```
    ## [13. Integer Intrinsics](https://docs.nvidia.com/cuda/archive/12.9.1/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__INT.html)
    ```diff
    ...
    ```
    ## [14. SIMD Intrinsics](https://docs.nvidia.com/cuda/archive/12.9.1/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__SIMD.html)
    ```diff
    ...
    ```
    ## [15. Structs](https://docs.nvidia.com/cuda/archive/12.9.1/cuda-math-api/cuda_math_api/structs.html)
    ```diff
    struct __half
    struct __half2
    struct __half2_raw
...
=== "13.0"
    ...
    ## [1. FP4 Intrinsics](https://docs.nvidia.com/cuda/archive/13.0.0/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__FP4.html)
    ```diff
    -4 bit floating point is not supported
    ```
    ## [2. FP6 Intrinsics](https://docs.nvidia.com/cuda/archive/13.0.0/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__FP6.html)
    ```diff
    -6 bit floating point is not supported
    ```
    ## [3. FP8 Intrinsics](https://docs.nvidia.com/cuda/archive/13.0.0/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__FP8.html)
    ```diff
    -8 bit floating point is not supported
    ```
    ## [4. Half Precision Intrinsics](https://docs.nvidia.com/cuda/archive/13.0.0/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__HALF.html)
    ```diff
    typedef __half __nv_half;
    typedef __half2 __nv_half2;
    typedef __half2_raw __nv_half2_raw;
    ...
    __device__ __half2 h2trunc(const __half2 h);
    ```
    ## [5. Bfloat16 Precision Intrinsics](https://docs.nvidia.com/cuda/archive/13.0.0/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__BFLOAT16.html)
    ```diff
    typedef __nv_bfloat16 nv_bfloat16;
    typedef __nv_bfloat162 nv_bfloat162;
    #define CUDART_INF_BF16
    ...
    __device__ __nv_bfloat162 h2trunc(const __nv_bfloat162 h);
    ```
    ## [6. Single Precision Mathematical Functions](https://docs.nvidia.com/cuda/archive/13.0.0/cuda-math-api/cuda_math_api/group__CUDA__MATH__SINGLE.html)
    ```diff
    __device__ float acosf(float x);
    __device__ float acoshf(float x);
    __device__ float asinf(float x);
    ...
    -__device__ float ynf(int n, float x);
    ```
    ## [7. Single Precision Intrinsics](https://docs.nvidia.com/cuda/archive/13.0.0/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__SINGLE.html)
    ```diff
    __device__ float __cosf(float x);
    __device__ float __exp10f(float x);
    __device__ float __expf(float x);
    ...
    __device__ float __tanhf(float x);
    ```
    ## [8. Double Precision Mathematical Functions](https://docs.nvidia.com/cuda/archive/13.0.0/cuda-math-api/cuda_math_api/group__CUDA__MATH__DOUBLE.html)
    ```diff
    __device__ double acos(double x);
    __device__ double acosh(double x);
    __device__ double asin(double x);
    ...
    -__device__ double yn(int n, double x);
    ```
    ## [9. Double Precision Intrinsics](https://docs.nvidia.com/cuda/archive/13.0.0/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__DOUBLE.html)
    ```diff
    __device__ double __dadd_rd(double x, double y);
    __device__ double __dadd_rn(double x, double y);
    __device__ double __dadd_ru(double x, double y);
    ...
    __device__ double __fma_rz(double x, double y, double z);
    ```
    ## [10. FP128 Quad Precision Mathematical Functions](https://docs.nvidia.com/cuda/archive/13.0.0/cuda-math-api/cuda_math_api/group__CUDA__MATH__QUAD.html)
    ```diff
    -128 bit floating point is not supported
    ```
    ## [11. Type Casting Intrinsics](https://docs.nvidia.com/cuda/archive/13.0.0/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__CAST.html)
    ```diff
    __device__ float __double2float_rd(double x);
    __device__ float __double2float_rn(double x);
    __device__ float __double2float_ru(double x);
    ...
    __device__ float __ull2float_rz(unsigned long long int x);
    ```
    ## [12. Integer Mathematical Functions](https://docs.nvidia.com/cuda/archive/13.0.0/cuda-math-api/cuda_math_api/group__CUDA__MATH__INT.html)
    ```diff
    __device__ long int abs(long int a);
    __device__ int abs(int a);
    __device__ long long int abs(long long int a);
    ...
    __device__ unsigned int umin(const unsigned int a, const unsigned int b);
    ```
    ## [13. Integer Intrinsics](https://docs.nvidia.com/cuda/archive/13.0.0/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__INT.html)
    ```diff
    __device__ unsigned int __brev(unsigned int x);
    __device__ unsigned long long int __brevll(unsigned long long int x);
    __device__ unsigned int __byte_perm(unsigned int x, unsigned int y, unsigned int s);
    ...
    __device__ unsigned int __usad(unsigned int x, unsigned int y, unsigned int z);
    ```
    ## [14. SIMD Intrinsics](https://docs.nvidia.com/cuda/archive/13.0.0/cuda-math-api/cuda_math_api/group__CUDA__MATH__INTRINSIC__SIMD.html)
    ```diff
    __device__ unsigned int __vabs2(unsigned int a);
    __device__ unsigned int __vabs4(unsigned int a);
    __device__ unsigned int __vabsdiffs2(unsigned int a, unsigned int b);
    ...
    __device__ unsigned int __vsubus4(unsigned int a, unsigned int b);
    ```
    ## [15. Structs](https://docs.nvidia.com/cuda/archive/13.0.0/cuda-math-api/cuda_math_api/structs.html)
    ```diff
    struct __half
    struct __half2
    struct __half2_raw
